                    ...
                    {blogs.map((blog) => (
                        <div key={blog.id} className='flex flex-col gap-2 w-full rounded group'>
                            ...
                            <span className='text-sm font-thin line-clamp-4'>
                                Dây chuyền vàng tây nữ là một món trang sức mang vẻ đẹp tinh tế, thanh lịch và sang
                                trọng. Dây chuyền vàng tây nữ là một món trang sức mang vẻ đẹp tinh tế, thanh lịch và
                                sang trọng. Những mẫu dây chuyền này vừa có mức giá phải chăng, vừa tạo được điểm nhấn
                                cho diện mạo. Hãy cùng Junie.vn... Những mẫu dây chuyền này vừa có mức giá phải chăng,
                                vừa tạo được điểm nhấn cho diện mạo. Hãy cùng Junie.vn...
                            </span>
                        </div>
                    ))}
                </div>
